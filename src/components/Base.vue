<template>
  <div>
    <div class="pt-3 pb-4 pl-4">
      ...
      <h5 class="text-muted">Write With Better Words // <span class="modal-btn" v-b-modal.modal-1>What Is This?</span></h5>
    </div>
    ...
    <div>
      <b-modal id="modal-1" title="What is Shorter Letter?" :ok-only="true">
        ...
        <p>Enter words you don't want to use under <b>Highlight</b> and they are highlighted in the main text. Edit them to use better words, create better sentences, and make your writing better.</p>
